...
This repository contains the documentation for **GrowKnow**, a modular platform for **AI news**, **AI tool discovery**, and **structured learning paths** for IT professionals.

The documentation reflects the current implementation direction: a **React/Vite frontend**, a **Django REST backend**, and **n8n automations** that ingest and enrich content.
...
The documentation repository is organized around the artifacts used to describe the project:

- `Diagrams/` — architecture, UML, activity, and data model diagrams.
- `UCs/` — use-case documentation.
- `Artifact_Contributors_Table.md` — artifact ownership and contributor mapping.
- `Software_Requirements_Specification.md` — requirements overview.
- `Software_Architecture_Document.md` — architecture overview.
- `README.md` — documentation hub.

The implementation repository is linked in the references section below.

## Local development

This repository does not contain the application runtime itself, so there is no local build or run process here.

For implementation setup and execution, use the linked project repository and the installer guide in `README_INSTALLER.md` from the source docs.

## Documentation

- `Software_Requirements_Specification.md` — functional and non-functional requirements.
- `Software_Architecture_Document.md` — system architecture and runtime view.
- `Artifact_Contributors_Table.md` — documentation and artifact ownership.
- `UCs/` — detailed use-case specifications.
...
| Test Plan | https://github.com/bermar24/GrowKnow_Documentation/blob/main/Test_Plan.md                         |
| Artifact and Contributors Table                                                      | https://github.com/bermar24/GrowKnow_Documentation/blob/main/Artifact_Contributors_Table.md         |
...
### Emin *(left the project at the beginning of December 2025)*
