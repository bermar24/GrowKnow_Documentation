# 3.1.5 Trigger Newsletter Run (Automation → Review → Publish)
...
![Trigger Newsletter Run Activity Diagram 1/2](../Diagrams/triggerNewslatter_Activity_Diagram.png)

![Trigger Newsletter Run Activity Diagram 2/2](../Diagrams/triggerNewslatter_Activity_Diagram_2.png)

### 2.1.7 Mock-up
![Trigger Newsletter Run Mockup](../Diagrams/triggerNewslatter_Mockup.png)
...
```
This Narrative is specified in a [separate document](https://github.com/bermar24/growknow/blob/main/features/steps/trigger_newsletter_run.py).
